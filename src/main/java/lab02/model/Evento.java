...
public abstract class Evento {
    ...
    */
     ...
     */
    public void venderIngresso(Cliente cliente) throws IngressoEsgotadoException, EventoNaoEncontradoException, SaldoInsuficienteException {
        ...
        if (cliente.getSaldo() < this.precoIngresso){
            throw new SaldoInsuficienteException("Saldo insuficiente para comprar o ingresso do evento: " + this.nome);
        }

        cliente.removerSaldo(this.precoIngresso); //remove o valor do ingresso do saldo do cliente
    ...
    public String toString() {
		return this.nome + " - " + this.data + " - " + "R$ " + getPrecoIngresso();
	}
